...
class IslamicDegree3 extends StatelessWidget {
  const IslamicDegree3({super.key});
  static String routName = 'IslamicDegree3';
          ...
          Container(
            ...
            child: Center(
              child: DataTable(
                ...
                rows: List.generate(islamicData3.length, (index) {
                  return DataRow(
                    cells: [

                      DataCell(Text(islamicData3[index].type,
                          style: TextStyle(fontSize: 20, color: kTextBlackColor))),

                      DataCell(Text(islamicData3[index].degree,
              ...
              children: [
                ...
                Expanded(
                  child: ListView.builder(
                    itemCount: islamicData3.length,
                    itemBuilder: (context, index) {
                      return Center(
                        child: Text(
                          islamicResultComment3[index].comment,
