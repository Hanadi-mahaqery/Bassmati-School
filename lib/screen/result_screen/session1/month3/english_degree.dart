...
class EnglishDegree3 extends StatelessWidget {
  const EnglishDegree3({Key? key}) : super(key: key);

  static String routName = 'EnglishDegree3';
          ...
          Container(
            ...
            child: Center(
              child: DataTable(
                ...
                rows: List.generate(englishData3.length, (index) {
                  return DataRow(
                    cells: [

                      DataCell(Text(englishData3[index].type,
                          style: TextStyle(fontSize: 20, color: kTextBlackColor))),

                      DataCell(Text(englishData3[index].degree,
              ...
              children: [
                ...
                Expanded(
                  child: ListView.builder(
                    itemCount:englishResultComment3.length,
                    itemBuilder: (context, index) {
                      return Center(
                        child: Text(
                          englishResultComment3[index].comment,
