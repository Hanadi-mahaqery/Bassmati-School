...
class ScienceDegree3 extends StatelessWidget {
  const ScienceDegree3({super.key});
  static String routName = 'ScienceDegree3';
          ...
          Container(
            ...
            child: Center(
              child: DataTable(
                ...
                rows: List.generate(scienceData3.length, (index) {
                  return DataRow(
                    cells: [

                      DataCell(Text(scienceData3[index].type,
                          style: TextStyle(fontSize: 20, color: kTextBlackColor))),

                      DataCell(Text(scienceData3[index].degree,
              ...
              children: [
                ...
                Expanded(
                  child: ListView.builder(
                    itemCount: scienceResultComment3.length,
                    itemBuilder: (context, index) {
                      return Center(
                        child: Text(
                          scienceResultComment3[index].comment,
