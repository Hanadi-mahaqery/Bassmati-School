...
class QuranDegree3 extends StatelessWidget {
  const QuranDegree3({super.key});
  static String routName = 'QuranDegree3';
          ...
          Container(
            ...
            child: Center(
              child: DataTable(
                ...
                rows: List.generate(quranData3.length, (index) {
                  return DataRow(
                    cells: [

                      DataCell(Text(quranData3[index].type,
                          style: TextStyle(fontSize: 20, color: kTextBlackColor))),

                      DataCell(Text(quranData3[index].degree,
              ...
              children: [
                ...
                Expanded(
                  child: ListView.builder(
                    itemCount: quranResultComment3.length,
                    itemBuilder: (context, index) {
                      return Center(
                        child: Text(
                          quranResultComment3[index].comment,
