...
class MathDegree3 extends StatelessWidget {
  const MathDegree3({super.key});
  static String routName = 'MathDegree3';
          ...
          Container(
            ...
            child: Center(
              child: DataTable(
                ...
                rows: List.generate(mathData3.length, (index) {
                  return DataRow(
                    cells: [

                      DataCell(Text(mathData3[index].type,
                          style: TextStyle(fontSize: 20, color: kTextBlackColor))),

                      DataCell(Text(mathData3[index].degree,
              ...
              children: [
                ...
                Expanded(
                  child: ListView.builder(
                    itemCount: mathResultComment3.length,
                    itemBuilder: (context, index) {
                      return Center(
                        child: Text(
                          mathResultComment3[index].comment,
