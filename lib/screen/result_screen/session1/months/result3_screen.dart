...
class Result3Screen extends StatelessWidget {
  const Result3Screen({super.key});
  static String routeName= 'Result3Screen';
              ...
              child: ListView.builder(
                  ...
                  itemBuilder: (
                    ...
                    return GestureDetector(
                      onTap: (){
                        print("============ rote tapped ==================");
                        print("============ ${result3[index].route} ==================");
                        Navigator.of(context).pushNamed(result3[index].route);
                      },
                      child: Container(
                            ...
                            Row(
                              ...
                              children: [
                                ...
                                Column(
                                  ...
                                  children: [
                                    Text(
                                      '${result3[index].obtainedMark}/${result3[index].totalMarks}',
                                      style: Theme.of(context).textTheme.bodyLarge,
                                    ),
                                    Stack(
                                      children: [
                                        Container(
                                          width: result3[index].totalMarks.toDouble(),
                                          height: 20.0,
                                          decoration: BoxDecoration(
                                        ...
                                        Container(
                                          height: 20.0,
                                          width: result3[index].obtainedMark.toDouble(),
                                          decoration: BoxDecoration(
                                              color: result3[index].grade =='D'
