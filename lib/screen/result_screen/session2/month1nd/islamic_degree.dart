...
class IslamicDegree4 extends StatelessWidget {
  const IslamicDegree4({Key? key}) : super(key: key);

  static String routName = 'IslamicDegree4';
          ...
          Container(
            ...
            child: Center(
              child: DataTable(
                ...
                rows: List.generate(islamicData4.length, (index) {
                  return DataRow(
                    cells: [

                      DataCell(Text(islamicData4[index].type,
                          style: TextStyle(fontSize: 20, color: kTextBlackColor))),

                      DataCell(Text(islamicData4[index].degree,
              ...
              children: [
                ...
                Expanded(
                  child: ListView.builder(
                    itemCount: islamicResultComment4.length,
                    itemBuilder: (context, index) {
                      return Center(
                        child: Text(
                          islamicResultComment4[index].comment,
