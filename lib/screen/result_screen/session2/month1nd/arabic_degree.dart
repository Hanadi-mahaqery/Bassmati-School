...
class ArabicDegree4 extends StatelessWidget {
  const ArabicDegree4({Key? key}) : super(key: key);

  static String routName = 'ArabicDegree4';
          ...
          Container(
            ...
            child: Center(
              child: DataTable(
                ...
                rows: List.generate(arabicData4.length, (index) {
                  return DataRow(
                    cells: [

                      DataCell(Text(arabicData4[index].type,
                          style: TextStyle(fontSize: 20, color: kTextBlackColor))),

                      DataCell(Text(arabicData4[index].degree,
              ...
              children: [
                ...
                Expanded(
                  child: ListView.builder(
                    itemCount: resultComment4.length,
                    itemBuilder: (context, index) {
                      return Center(
                        child: Text(
                          resultComment4[index].comment,
