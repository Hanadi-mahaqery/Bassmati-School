...
class EnglishDegree4 extends StatelessWidget {
  const EnglishDegree4({Key? key}) : super(key: key);

  static String routName = 'EnglishDegree4';
          ...
          Container(
            ...
            child: Center(
              child: DataTable(
                ...
                rows: List.generate(englishData5.length, (index) {
                  return DataRow(
                    cells: [

                      DataCell(Text(englishData5[index].type,
                          style: TextStyle(fontSize: 20, color: kTextBlackColor))),

                      DataCell(Text(englishData5[index].degree,
              ...
              children: [
                ...
                Expanded(
                  child: ListView.builder(
                    itemCount:englishResultComment5.length,
                    itemBuilder: (context, index) {
                      return Center(
                        child: Text(
                          englishResultComment5[index].comment,
