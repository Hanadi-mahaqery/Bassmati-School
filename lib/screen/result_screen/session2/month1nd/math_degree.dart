...
class MathDegree4 extends StatelessWidget {
  const MathDegree4({Key? key}) : super(key: key);

  static String routName = 'MathDegree4';
          ...
          Container(
            ...
            child: Center(
              child: DataTable(
                ...
                rows: List.generate(mathData4.length, (index) {
                  return DataRow(
                    cells: [

                      DataCell(Text(mathData4[index].type,
                          style: TextStyle(fontSize: 20, color: kTextBlackColor))),

                      DataCell(Text(mathData4[index].degree,
              ...
              children: [
                ...
                Expanded(
                  child: ListView.builder(
                    itemCount: mathResultComment4.length,
                    itemBuilder: (context, index) {
                      return Center(
                        child: Text(
                          mathResultComment4[index].comment,
