...
class QuranDegree4 extends StatelessWidget {
  const QuranDegree4({Key? key}) : super(key: key);

  static String routName = 'QuranDegree4';
          ...
          Container(
            ...
            child: Center(
              child: DataTable(
                ...
                rows: List.generate(quranData4.length, (index) {
                  return DataRow(
                    cells: [

                      DataCell(Text(quranData4[index].type,
                          style: TextStyle(fontSize: 20, color: kTextBlackColor))),

                      DataCell(Text(quranData4[index].degree,
              ...
              children: [
                ...
                Expanded(
                  child: ListView.builder(
                    itemCount: quranResultComment4.length,
                    itemBuilder: (context, index) {
                      return Center(
                        child: Text(
                          quranResultComment4[index].comment,
