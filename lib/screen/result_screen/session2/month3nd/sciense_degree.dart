...
class ScienceDegree6 extends StatelessWidget {
  const ScienceDegree6({Key? key}) : super(key: key);

  static String routName = 'ScienceDegree6';
          ...
          Container(
            ...
            child: Center(
              child: DataTable(
                ...
                rows: List.generate(scienceData6.length, (index) {
                  return DataRow(
                    cells: [

                      DataCell(Text(scienceData6[index].type,
                          style: TextStyle(fontSize: 20, color: kTextBlackColor))),

                      DataCell(Text(scienceData6[index].degree,
              ...
              children: [
                ...
                Expanded(
                  child: ListView.builder(
                    itemCount: scienceResultComment6.length,
                    itemBuilder: (context, index) {
                      return Center(
                        child: Text(
                          scienceResultComment6[index].comment,
