...
class IslamicDegree6 extends StatelessWidget {
  const IslamicDegree6({Key? key}) : super(key: key);

  static String routName = 'IslamicDegree6';
          ...
          Container(
            ...
            child: Center(
              child: DataTable(
                ...
                rows: List.generate(islamicData6.length, (index) {
                  return DataRow(
                    cells: [

                      DataCell(Text(islamicData6[index].type,
                          style: TextStyle(fontSize: 20, color: kTextBlackColor))),

                      DataCell(Text(islamicData6[index].degree,
              ...
              children: [
                ...
                Expanded(
                  child: ListView.builder(
                    itemCount: islamicResultComment6.length,
                    itemBuilder: (context, index) {
                      return Center(
                        child: Text(
                          islamicResultComment6[index].comment,
