...
class QuranDegree6 extends StatelessWidget {
  const QuranDegree6({Key? key}) : super(key: key);

  static String routName = 'QuranDegree6';
          ...
          Container(
            ...
            child: Center(
              child: DataTable(
                ...
                rows: List.generate(quranData6.length, (index) {
                  return DataRow(
                    cells: [

                      DataCell(Text(quranData6[index].type,
                          style: TextStyle(fontSize: 20, color: kTextBlackColor))),

                      DataCell(Text(quranData6[index].degree,
              ...
              children: [
                ...
                Expanded(
                  child: ListView.builder(
                    itemCount: quranResultComment6.length,
                    itemBuilder: (context, index) {
                      return Center(
                        child: Text(
                          quranResultComment6[index].comment,
