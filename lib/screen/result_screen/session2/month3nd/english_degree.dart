...
class EnglishDegree6 extends StatelessWidget {
  const EnglishDegree6({Key? key}) : super(key: key);

  static String routName = 'EnglishDegree6';

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('English Degree'),
      ),
      body: Column(
        children: [
          Container(
            ...
            child: Center(
              child: DataTable(
                ...
                rows: List.generate(englishData6.length, (index) {
                  return DataRow(
                    cells: [

                      DataCell(Text(englishData6[index].type,
                          style: TextStyle(fontSize: 20, color: kTextBlackColor))),

                      DataCell(Text(englishData6[index].degree,
              ...
              children: [
                ...
                Expanded(
                  child: ListView.builder(
                    itemCount:englishResultComment6.length,
                    itemBuilder: (context, index) {
                      return Center(
                        child: Text(
                          englishResultComment6[index].comment,
