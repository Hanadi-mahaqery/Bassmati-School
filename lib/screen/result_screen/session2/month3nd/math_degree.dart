...
class MathDegree6 extends StatelessWidget {
  const MathDegree6({Key? key}) : super(key: key);

  static String routName = 'MathDegree6';
          ...
          Container(
            ...
            child: Center(
              child: DataTable(
                ...
                rows: List.generate(mathData6.length, (index) {
                  return DataRow(
                    cells: [

                      DataCell(Text(mathData6[index].type,
                          style: TextStyle(fontSize: 20, color: kTextBlackColor))),

                      DataCell(Text(mathData6[index].degree,
              ...
              children: [
                ...
                Expanded(
                  child: ListView.builder(
                    itemCount: mathResultComment6.length,
                    itemBuilder: (context, index) {
                      return Center(
                        child: Text(
                          mathResultComment6[index].comment,
