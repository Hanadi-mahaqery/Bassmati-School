...
class ScienceDegree5 extends StatelessWidget {
  const ScienceDegree5({Key? key}) : super(key: key);

  static String routName = 'ScienceDegree5';
          ...
          Container(
            ...
            child: Center(
              child: DataTable(
                ...
                rows: List.generate(scienceData5.length, (index) {
                  return DataRow(
                    cells: [

                      DataCell(Text(scienceData5[index].type,
                          style: TextStyle(fontSize: 20, color: kTextBlackColor))),

                      DataCell(Text(scienceData5[index].degree,
              ...
              children: [
                ...
                Expanded(
                  child: ListView.builder(
                    itemCount: scienceResultComment5.length,
                    itemBuilder: (context, index) {
                      return Center(
                        child: Text(
                          scienceResultComment5[index].comment,
