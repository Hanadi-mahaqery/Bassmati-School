...
class IslamicDegree5 extends StatelessWidget {
  const IslamicDegree5({Key? key}) : super(key: key);

  static String routName = 'IslamicDegree5';
          ...
          Container(
            ...
            child: Center(
              child: DataTable(
                ...
                rows: List.generate(islamicData5.length, (index) {
                  return DataRow(
                    cells: [

                      DataCell(Text(islamicData5[index].type,
                          style: TextStyle(fontSize: 20, color: kTextBlackColor))),

                      DataCell(Text(islamicData5[index].degree,
              ...
              children: [
                ...
                Expanded(
                  child: ListView.builder(
                    itemCount: islamicResultComment5.length,
                    itemBuilder: (context, index) {
                      return Center(
                        child: Text(
                          islamicResultComment5[index].comment,
