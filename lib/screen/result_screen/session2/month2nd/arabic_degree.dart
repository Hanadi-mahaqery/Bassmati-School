...
class ArabicDegree5 extends StatelessWidget {
  const ArabicDegree5({Key? key}) : super(key: key);

  static String routName = 'ArabicDegree5';
          ...
          Container(
            ...
            child: Center(
              child: DataTable(
                ...
                rows: List.generate(arabicData5.length, (index) {
                  return DataRow(
                    cells: [

                      DataCell(Text(arabicData5[index].type,
                          style: TextStyle(fontSize: 20, color: kTextBlackColor))),

                      DataCell(Text(arabicData5[index].degree,
              ...
              children: [
                ...
                Expanded(
                  child: ListView.builder(
                    itemCount: resultComment5.length,
                    itemBuilder: (context, index) {
                      return Center(
                        child: Text(
                          resultComment5[index].comment,
