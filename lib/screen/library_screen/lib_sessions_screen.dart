...
class LibSessionsScreen extends StatelessWidget {
  const LibSessionsScreen({super.key});
  static String routName = 'LibSessionsScreen';
            ...
            child: ListView(
              ...
              children: [
                Column(
                  mainAxisAlignment: MainAxisAlignment.center,
                  children: [
                    LibType(title: 'First Semester', icon: 'assets/icons/library.png', onPress:(){
                      Navigator.pushNamed(context, LibraryType.routName);
                    }) ,
                    LibType(title: 'Second Semester', icon:'assets/icons/library.png', onPress:(){
