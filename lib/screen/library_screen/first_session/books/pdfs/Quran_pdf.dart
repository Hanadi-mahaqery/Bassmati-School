...
class QuranPdfContentScreen extends StatelessWidget {
  final int subjectId;
  final String subjectName;

  const QuranPdfContentScreen({Key? key, required this.subjectId, required this.subjectName}) : super(key: key);

  static const String routeName = 'QuranPdfContentScreen';
