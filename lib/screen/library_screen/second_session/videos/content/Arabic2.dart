...
class Arabic2ContentScreen extends StatelessWidget {
  const Arabic2ContentScreen({super.key});
  static const String routeName ='Arabic2ContentScreen';
                      ...
                      children: [
                        Column(
                          children: [
                            ...
                            Text(contentData[index].videoId,
                              style: TextStyle(
                                color: kTextBlackColor,
                                fontSize: 13.0,
