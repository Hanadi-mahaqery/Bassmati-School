...
class VideosSecondSession extends StatelessWidget {
  const VideosSecondSession({super.key});
  static String routName = 'VideosSecondSession';
                ...
                Column(
                  ...
                  children: [
                    LibType(title: 'Quran', icon: 'assets/icons/library.png', onPress:(){
                      Navigator.pushNamed(context, Quran2ContentScreen.routeName);
                    }) ,
                    LibType(title: 'Islamic', icon:'assets/icons/library.png', onPress:(){
                      Navigator.pushNamed(context, Islamic2ContentScreen.routeName);
                    }) ,
                    LibType(title: 'Arabic', icon:'assets/icons/library.png', onPress:(){
                      Navigator.pushNamed(context, Arabic2ContentScreen.routeName );
                    }) ,
                    LibType(title: 'Math', icon:'assets/icons/library.png', onPress:(){
                      Navigator.pushNamed(context, Math2ContentScreen.routeName );
                    }) ,
                    LibType(title: 'English', icon:'assets/icons/library.png', onPress:(){
                      Navigator.pushNamed(context,English2ContentScreen.routeName );
                    }) ,
                    LibType(title: 'Science', icon:'assets/icons/library.png', onPress:(){
                      Navigator.pushNamed(context,Science2ContentScreen.routeName );
                    }) ,
